...
export default function About() {
  return (
    <div className="aboutContainer">
      ...
      <Text>
        Some of the solutions may have wrong indentation which is a problem within the webscraped code. Please
        report these solutions (when implemented) so they can be fixed!
      </Text>
      <br />
