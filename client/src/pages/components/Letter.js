...
export default function Letter(props) {
        const { idx, displayWord, char, userInput, active, hasReturn, wordCorrect, activeWordIndex, thisWordIndex} = props
        ...
        if (correct === true) {
                if (active) {
                        if (hasReturn && isLastChar) return <span className = 'currentCorrect displayText'>{char}<br/></span>
                        ...
                        if (hasReturn && isLastChar) return <span className="correct displayText">{char}<br/></span>
                        if(isLastChar) return <span className = "correct displayText">{char} </span>
                        return <span className="correct displayText">{char}</span>
                }
        ...
        if (correct === false) {
                if (active) {
                        if (hasReturn && isLastChar) return <span className="currentIncorrect displayText">{char}<br/></span>
                        if(isLastChar) return <span className =  "currentIncorrect displayText">{char} </span>
                        return <span className ="currentIncorrect displayText">{char}</span>
                } else {
                        if (hasReturn && isLastChar) return <span className="incorrect displayText">{char}<br/></span>
                        if(isLastChar) return <span className = "incorrect displayText">{char} </span>
                        return <span className ="incorrect displayText">{char}</span>
                }
